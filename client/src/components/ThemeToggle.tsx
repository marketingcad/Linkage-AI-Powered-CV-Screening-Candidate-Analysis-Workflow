...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex h-9 w-9 items-center justify-center rounded-lg text-slate-600 transition hover:bg-slate-100 hover:text-slate-700 disabled:opacity-80"
      disabled={loading}
    >
      {loading ? (
